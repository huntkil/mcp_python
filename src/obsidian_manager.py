...
import logging
from .utils import sanitize_filename, extract_frontmatter, parse_frontmatter
...
class ObsidianManager:
    ...
    def get_vault_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            attachment_files = list(self.attachments_path.rglob("*")) if self.attachments_path.exists() else []
            ...
            return {
                ...
                "created_at": datetime.fromtimestamp(self.vault_path.stat().st_ctime).isoformat(),
                "last_modified": datetime.fromtimestamp(self.vault_path.stat().st_mtime).isoformat()
            }
    ...
    def create_note(self, note_path: str, content: str = "", frontmatter: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if frontmatter:
                full_content += "---\n"
                full_content += yaml.dump(frontmatter, default_flow_style=False, allow_unicode=True)
                full_content += "---\n\n"
    ...
    def update_note(self, note_path: str, content: Optional[str] = None, 
        ...
        try:
            ...
            # Prepare new content
            new_frontmatter = frontmatter if frontmatter is not None else existing_frontmatter
            ...
            if new_frontmatter:
                full_content += "---\n"
                full_content += yaml.dump(new_frontmatter, default_flow_style=False, allow_unicode=True)
                full_content += "---\n\n"
    ...
    def delete_note(self, note_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            note_info = self.read_note(note_path)
    ...
    def search_notes(self, query: str, folder: str = "", case_sensitive: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def create_template(self, template_name: str, content: str, frontmatter: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
    ...
    def create_note_from_template(self, template_name: str, note_path: str, 
